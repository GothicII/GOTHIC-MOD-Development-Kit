...
""" 
Name: 'Gothic 3DS with full Texurenames (.3ds)...'
Blender: 243
Group: 'Export'
Tooltip: 'Export to Gothic 3DS file format (.3ds). Textures'
"""

__author__ = ["Campbell Barton", "Bob Holcomb", "Richard Laerkaeng", "Damien McGinnes", "Mark Stijnman", "Christoffer Anselm", "AVK93"]
...
This script Exports an upscaled 3ds file.

Exporting is based on 3ds loader from www.gametutorials.com(Thanks DigiBen) and using information
from the lib3ds project (http://lib3ds.sourceforge.net/) sourcecode.

01/25/2008 modded by Christoffer Anselm:
- upscaling functionality added to make the exported files usable in Gothic 1 and 2.
- Scalefactor: 1 Box matches the character height of a Gothic NPC
"""
...
class _3ds_point_3d(object):
	...
	def write(self,file):
		file.write(struct.pack('<3f', self.x * 250, self.y * 250, self.z * 250))
